package com.gerwalex.mymonma.database

import android.content.ContentValues
import android.database.Cursor
import androidx.annotation.CallSuper
import androidx.room.Ignore
import com.gerwalex.mymonma.database.room.MonMaConverter
...
open class ObservableTableRowNew() {
    ...
    fun put(column: String, date: Date): Boolean {
        ...
        currentContent.put(column, MonMaConverter.toString(date))
        return oldval == date
    }
