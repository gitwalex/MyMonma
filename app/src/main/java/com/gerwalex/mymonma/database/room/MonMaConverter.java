...
public class MonMaConverter {
    ...
    public static LabelFormatter currencyLabelFormatter = MonMaConverter::convertCurrency;
    public static LabelFormatter percentLabelFormatter = MonMaConverter::convertPercent;
